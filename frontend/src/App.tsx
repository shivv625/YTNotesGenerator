...
import brevixLogo from "./assets/brevix-logo.png";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              />
              <div className="flex flex-col items-end justify-center flex-center-vertical text-right">
                <span className="text-2xl font-extrabold coolvetica bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent tracking-wide drop-shadow-lg">
                  BreviX AI
                </span>
          ...
          <div className="bg-gray-900/80 backdrop-blur-sm rounded-3xl p-12 border border-gray-700 shadow-2xl">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg hover:bg-gray-700 transition-colors duration-200"
              >
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div className="flex flex-col">
                  <span className="text-xl font-bold">BreviX AI</span>
                  <span className="text-xs text-gray-400 -mt-1">
                    powered by Alternex
                  </span>
                </div>
